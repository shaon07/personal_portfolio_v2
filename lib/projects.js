...
// @vercel/blob is loaded lazily (dynamic import) only when a token is present.
// A top-level static import of this package breaks the serverless function
// bundle on Next 12, so we keep it out of the module's load path entirely.
